  ...
  <section class="u-clearfix u-palette-1-light-2 u-section-1" id="sec-4761">
    <div class="u-clearfix u-sheet u-sheet-1">
      <div class="u-expanded-width-xs u-form u-form-1">
        <form action="Register.php" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form"
          style="padding: 10px;">
          ...
          <div class="u-form-date u-form-group u-form-partition-factor-2 u-form-group-4">
            ...
            <input type="text" readonly="readonly" placeholder="MM/DD/YYYY" id="mobi-picker" mbsc-input name="date"
              class="u-input u-input-rectangle" required="required" data-date-format="mm/dd/yyyy">
          </div>
          ...
          <div class="u-form-group u-form-group-8">
            ...
            <input type="password" placeholder="Enter you password" id="text-55a9" name="password"
          ...
          <div class="u-form-group u-form-group-9">
            ...
            <input type="password" placeholder="Re-enter your password" id="text-92a4" name="confirm-password"
              class="u-input u-input-rectangle" required="required">
          </div>
